...
What is **not** proved is exactly that the final **intrinsic longitudinal helicity-curvature rate** cannot sustain the endpoint.  Static full-convolution geometry is exhausted: equal-heat/source-line multiplicity is finite and the hard symbol has no hidden deep-parent decay.  The rank-one stress identities (20.198)--(20.211) show that normal/biaxial stress escape is viscously owned; the Gauss split (20.203)--(20.209) identifies pressure as extrinsic Hodge curvature; and (20.212)--(20.214) removes that pressure direction from the endpoint altogether.  By (20.215)--(20.221) the surviving source is the divergence-free longitudinal derivative of intrinsic helicity curvature; its Gauss square cancels identically, leaving the canonical symmetric off-diagonal Codazzi tensor together with intrinsic Ricci/Hodge curvature and the genuine viscous carre-du-champ.  Existing kinetic mass/Fisher/Hardy owners and all even/native-cubic hidden-potential routes still fall short.  Thus the remaining theorem is genuinely dynamic: rule out infinite UV `L_t^2H^-1` longitudinal-Codazzi concentration on the true divergence-free NS state manifold.  No such finite physical rate budget has been proved here, so `Y=>bot` remains open.
## 21. QED hook
