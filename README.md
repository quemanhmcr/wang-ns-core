...
**OPEN:** prove a measure-level quantitative cover for simultaneous minority, spin-2 majority and extra-output source cancellation in the comparable-scale regime.  Hodge/entropy may only read this already-physical source family downstream.
