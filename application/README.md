...
- [clay_problem/theory2_interaction_frame/](clay_problem/theory2_interaction_frame/) là spine blow-up theorem-first: complete Theory-2 state + moving heat geometry + three-scale UV locality + complete-core compactness / no-persistent-drift frontier.
